...
/// </summary>
public abstract class BaseDotBahnClient(BaseDotBahnConfiguration configuration, ITokenService tokenService, HttpClient httpClient) : IDisposable
{
    protected readonly BaseDotBahnConfiguration Configuration = configuration ?? throw new ArgumentNullException(nameof(configuration));
